...
from stretch_tablet.utils import Ry, spherical_to_cartesian, vector_projection
...
class TabletPlanner:
    def __init__(self):
        ...
        urdf_path = os.path.join(
            os.path.expanduser("~"),
            "ament_ws/src/stretch_show_tablet/stretch_tablet/description/stretch_base_rotation_ik.urdf",
        )
