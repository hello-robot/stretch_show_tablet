...
def main(json_path: str):
    ...
    plot_base_reachability(a, base_x=base_x, base_y=base_y, counts=counts, targets=targets)
    ...
    for point in human_xy.T:
        ...
        #     continue
        p = Circle(point, radius=human_inflation_distance, color='grey', alpha=0.3, zorder=0)
        a.add_patch(p)
